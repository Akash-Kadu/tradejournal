...
const injectStyles = () => {
  ...
  s.textContent = `
    ...
    @media (min-width: 769px) {
      .dp-mobile-topbar { display: none !important; }
      .dp-mobile-perf { display: none !important; }
      .dp-mobile-datepicker { display: none !important; }
    }
  \`;
  ...
  return (
    <div className="layout" style={{ display: 'flex', background: '#f8fafc', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main className="main-content" style={{ flex: 1, padding: '12px 22px', overflowY: 'auto', minWidth: 0 }}>
        ...
        {/* ── Mobile top bar ──────────────────────────────────────── */}
        <div className="dp-mobile-topbar" style={{ display: 'none', margin: '-12px -22px 12px', width: 'calc(100% + 44px)' }}>
          <div>
        ...
        {/* ── Desktop Header ──────────────────────────────────────── */}
        <div className="dp-desktop-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
          <div>
        ...
        {/* ── Stats row ──────────────────────────────────────────── */}
        <div className="dp-stats-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr 1fr 1fr 2.6fr', gap: 10, marginBottom: 12, ...fadeIn }}>
        ...
        <div className="dp-bottom-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 520px', gap: 12, ...fadeIn, transitionDelay: '.1s', alignItems: 'stretch' }}>
  ...
  return (
    ...
    >
      ...
      {d && inRange && <div style={{ fontSize: 10, color: tc, opacity: .85 }}>
        ...
        <div className="dp-mobile-perf" style={{ display: 'none', background: '#fff', border: '1px solid #e2e8f0', borderRadius: 12, padding: '14px 16px', marginTop: 12, boxShadow: '0 1px 4px rgba(0,0,0,.06)'}}>
