        ...
        <div style={{ width:'100%', maxWidth:900 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:32 }}>
            ...
            <div style={{ background:'#fff', borderRadius:14, padding:28, border:'1px solid #e2e8f0', boxShadow:'0 1px 3px rgba(0,0,0,.06)' }}>
              ...
              {error && tab === 'login' && <div style={{ background:'#fee2e2', color:'#b91c1c', padding:'8px 12px', borderRadius:8, fontSize:13, marginBottom:14 }}>{error}</div>}
            ...
            <div style={{ background:'#fff', borderRadius:14, padding:28, border:'1px solid #e2e8f0', boxShadow:'0 1px 3px rgba(0,0,0,.06)' }}>
              ...
              {error && tab === 'register' && <div style={{ background:'#fee2e2', color:'#b91c1c', padding:'8px 12px', borderRadius:8, fontSize:13, marginBottom:14 }}>{error}</div>}
              <form onSubmit={e => { setTab('register'); handleRegister(e); }}>
                {[
                  ...
                  <div key={key} style={{ marginBottom:12 }}>
                    ...
                    <input type={type} required placeholder={placeholder} value={regData[key]} onChange={e => setRegData({...regData, [key]:e.target.value})} style={{ width:'100%', padding:'8px 11px', border:'1px solid #e2e8f0', borderRadius:8, fontSize:13.5, fontFamily:'inherit', outline:'none' }}/>
                  </div>
                ))}
                <label style={{ display:'flex', alignItems:'center', gap:8, fontSize:13, color:'#475569', cursor:'pointer', marginBottom:16 }}>
          ...
          <p style={{ textAlign:'center', fontSize:12, color:'#94a3b8', marginTop:20 }}>
            By continuing, you agree to our <span style={{ color:'#2563eb' }}>Terms of Service</span> and <span style={{ color:'#2563eb' }}>Privacy Policy</span>.
          </p>
        </div>
      </div>
    </div>
